...
path('cours/ajout/', cours_create, name='cours_create'),
path('sujet/ajout/', sujet_create, name='sujet_create'),
path('evenement/ajout/', evenement_create, name='evenement_create'),
