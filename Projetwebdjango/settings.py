"""
Django settings for Projetwebdjango project.
...
SECRET_KEY = 'django-insecure-$ym*6p6uchem!=1)og1oc7yzj%#f@@z*^(h$%n22e6^jj*-_3('
...
INSTALLED_APPS = [
    'cours.apps.CoursConfig',    #Ajout de notre application cours
