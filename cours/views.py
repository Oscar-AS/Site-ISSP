...
#  indice_T = request.GET.get('indice_T')
  #liste_cours_recherche = []
  #context1 = {"indice_T": indice_T}

 # if indice_T : 
  #  liste_cours_recherche = Cours.objects.filter(Niveau_concerné = 'option1', Type_document = 'option1' , Titre__icontains = indice_T)
  #return render(request,"Acceuil_L1_search.html",context1,{"liste_cours_recherche ": liste_cours_recherche})
